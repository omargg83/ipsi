		...
		<div class='cell'>Activo</div>
			...
			<?php
				foreach($pd as $key){
					...
					?>
								<button class='btn btn-warning btn-sm' type="button" is="b-link" des='a_terapeutas/editar' dix='trabajo' tp="edit" v_idusuario='<?php echo $key->idusuario; ?>' title='editar'>Editar</button>
								</div>
							</div>
