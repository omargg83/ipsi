...
<div class="container">
	<form is="f-submit" id="form_personal" db="a_terapeutas/db_" fun="guardar_usuario" des="a_terapeutas/editar" dix="trabajo" desid="idusuario" v_idusuario="<?php echo $idusuario; ?>">
				...
				<div class="col-sm-12">
					...
					<?php
						if($idusuario>0){
							...
							echo "<button class='btn btn-warning' type='button' is='b-link' des='a_terapeutas/horarios' v_idusuario='$idusuario' dix='trabajo'>Horarios</button>";
						}

						echo "<button class='btn btn-warning' type='button' is='b-link' des='a_terapeutas/terapeuta' dix='trabajo' v_idusuario='$idusuario'>Regresar</button>";
