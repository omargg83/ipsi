...
?>
<form is="f-submit" id="form_foto" db="a_paciente_perfil/db_" fun="foto" cmodal="1" des="a_paciente_perfil/index" v_idpaciente="<?php echo $idpaciente; ?>" cmodal='1' dix='contenido'>
