                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href='#a_terapia/index' title='Terapias'><div class="sb-nav-link-icon"><i class='far fa-file-alt'></i></div> Terapias</a>
                            <a class="nav-link" href='#a_track/index' title='Track'><div class="sb-nav-link-icon"><i class='far fa-file-alt'></i></div>Tracks</a>
                            <a class="nav-link" href='#a_actividades/index' is='menu-link' title='Actividades'><div class="sb-nav-link-icon"><i class='far fa-file-alt'></i></div>Actividades</a>
