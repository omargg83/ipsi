...
///////////////////////////////////////vainija.js
	...
	function sortTable(n) {
	  ...
	  table = document.getElementById("tabla_css");
		var divs = table.getElementsByClassName("body-row").length;
	  switching = true;
	  ...
	  while (switching) {
	    ...
	    for (i = 0; i < (divs-1); i++) {
	      ...
	      one from current row and one from the next: */
				x=table.getElementsByClassName("body-row")[i].getElementsByClassName("cell")[n];
				y=table.getElementsByClassName("body-row")[i+1].getElementsByClassName("cell")[n];
				/*
	    ...
	    if (shouldSwitch) {
	      ...
	      and mark that a switch has been done: */
				table.getElementsByClassName("body-row")[i].parentNode.insertBefore(table.getElementsByClassName("body-row")[i+1], table.getElementsByClassName("body-row")[i]);
