  ...
  <div class='row'>
  		...
  		<div class='col-4 p-3 w-50'>
  			<div class='card' style='height:200px;'>
					<div class="card-header">
						<?php echo $key->nombre; ?>
						<button class="btn btn-warning btn-sm float-right" type="button" is="b-link" des="a_pacientes_e/terapias_editar" dix="trabajo" id1="<?php echo $key->id; ?>">Editar</button>
					</div>
  				<div class='card-body'>
  					<div class='row'>
							<div class='col-12'>
      ...
      <div class="card" style='height:200px;'>
        <div class='card-body text-center'>
          <button class="btn btn-warning btn-block" type="button" is="b-link" des="a_pacientes_e/terapias_editar" dix="trabajo" id1="0">Nueva terapia</button>
        </div>
      </div>
    </div>
  </div>
