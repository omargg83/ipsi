...
<nav aria-label='breadcrumb'>
 <ol class='breadcrumb'>
	 ...
	 <li class="breadcrumb-item" id='lista_track' is="li-link" des="a_pacientes/actividades" dix="contenido" v_idmodulo="<?php echo $modulo->id; ?>" v_idpaciente="<?php echo $idpaciente; ?>"><?php echo $modulo->nombre; ?></li>
	 <li class="breadcrumb-item active" id='lista_track' is="li-link" des="a_pacientes/actividad_ver" dix="contenido" v_idactividad="<?php echo $idactividad; ?>" v_idpaciente="<?php echo $idpaciente; ?>"><?php echo $nombre_act; ?></li>
 </ol>
</nav>
	...
	<div class="card mb-3">
		<div class="card-header" id="headingOne">
			<div class='row'>
				<div class="col-2">
					<!---Editar actividad --->
					<button class="btn btn-warning btn-sm" type="button" is="b-link" des="a_pacientes_e/actividad_editar" v_idactividad="<?php echo $idactividad; ?>" v_idpaciente="<?php echo $idpaciente; ?>" omodal="1"><i class="fas fa-pencil-alt"></i></button>
				</div>
				...
				<div class="col-1">
					<button class="btn btn-warning btn-sm float-right" type="button" is="b-link" des="a_pacientes/paciente" dix="contenido" id1="<?php echo $id1; ?>">Regresar</button>
				</div>
			</div>
		</div>
...
?>
	...
	<!-- fin de Subactividad  -->
		...
		<div id="collapsesub<?php echo $key->idsubactividad; ?>" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
			...
			<div class="container-fluid mb-3 text-center">
				<button class="btn btn-warning btn-sm" type="button" is="b-link" des="a_pacientes/bloque" v_idactividad="<?php echo $idactividad; ?>" v_idsubactividad="<?php echo $key->idsubactividad; ?>" id3="texto" params='tipo-imagen' omodal="1" >Bloque</button>
			</div>
