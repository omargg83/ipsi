...
<div class="container">
	<form action="" id="form_cliente" data-lugar="a_psicologos/db_" data-funcion="guardar_psicologo" data-destino='a_psicologos/editar'>
					...
					<div class="col-sm-12">
						...
						<?php
							if($id>0){
								...
								echo "<button type='button' class='btn btn-sm' id='winmodal_pass' data-id='$id' data-lugar='a_psicologos/form_pass' title='Cambiar contraseña' ><i class='fas fa-key'></i>Contraseña</button>";
							}
						?>
