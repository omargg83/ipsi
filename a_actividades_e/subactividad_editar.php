...
<form is="f-submit" id="form_sub" db="a_actividades/db_" fun="subactividad_guardar" lug="a_actividades/actividad_ver" id1="<?php echo $idactividad; ?>" dix="trabajo" cmodal="1">
