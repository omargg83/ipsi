			...
			<div class='row text-center'>
				<div class='card col-12'>
					...
					<div class='card-body'>
						<div class='col-12'>
							<?php
								echo "<button type='button' class='btn btn-sm' id='winmodal_pass' data-id='$id' data-lugar='a_clientes/form_terapia' title='Cambiar contraseña' >Agregar terapia</button>";
							?>
						</div>
					</div>
				</div>
