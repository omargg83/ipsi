...
?>
  ...
  <div class="card">
    ...
    <div class="card-body text-center">
      ...
      <button class="btn btn-warning btn-lg" type="button" is="b-link" des="a_actividades_e/contexto_editar" id1="0" id2="<?php echo $idactividad; ?>" id3="<?php echo $idsubactividad; ?>" params='tipo-pregunta' omodal="1">Pregunta</button>
    </div>
    <div class="card-header">
      Bloque Respuesta
    </div>
