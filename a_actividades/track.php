...
<nav aria-label='breadcrumb'>
  <ol class='breadcrumb'>
    <li class="breadcrumb-item" type="button" is="li-link" des="a_pacientes/terapias" dix="trabajo" title="Inicio" id1="">Inicio</li>
    <li class="breadcrumb-item active" type="button" is="li-link" des="a_pacientes/track" dix="trabajo" title="Terapias" id1="<?php echo $idterapia; ?>"><?php echo $terapia->nombre; ?></li>
  </ol>
</nav>
  		...
  		<div class='col-4 p-3 w-50'>
  			<div class='card' style='height:200px;'>
  				...
  				<div class='card-body'>
  					<div class='row'>
  						<div class='col-12'>
  							<button class="btn btn-warning btn-block" type="button" is="b-link" des="a_pacientes/modulos" dix="trabajo" id1="<?php echo $key->id; ?>" id2="<?php echo $idterapia; ?>">Ver</button>
  						</div>
  					</div>
  				</div>
  			</div>
